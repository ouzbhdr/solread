      ...
      <main className="relative z-10 max-w-5xl mx-auto px-4 py-12 flex-1 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 flex flex-col items-center gap-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-purple-950/60 border border-purple-800/40 rounded-full text-xs font-mono text-purple-400">
            ...
            <span><span>SOLANA WEB3 MONETIZATION ENGINE</span></span>
          </div>
        ...
        {/* Code Output Panel (Directly under title) */}
        <div className="max-w-3xl mx-auto bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.5)] w-full mb-16">
        ...
        {/* Step 1: Design & Preview (Side-by-Side Widget Builder & Live Preview) */}
        ...
        {/* How Integration Works Guide (Centered) */}
        <div className="max-w-3xl mx-auto bg-slate-900/40 border border-slate-800 rounded-2xl p-6 mb-16">
